  ...
  return (
    ...
    >
      <Reveal
        ...
        className="h-full w-full"
      >
        <div className="h-full w-full bg-ctp-surface0/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 md:p-10 flex flex-col justify-between border border-ctp-surface0/50 hover:border-ctp-surface1/50 transition-colors relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col items-start">
          ...
          <p className="text-xs sm:text-sm md:text-base text-ctp-subtext0 leading-relaxed max-w-sm sm:max-w-md mb-8 sm:mb-10">
            Currently open to exciting projects and collaborations. I specialize
            in crafting modern web applications and optimizing developer
            workflows.
          </p>
        </div>
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-4 mt-auto border-t border-ctp-surface1/30 pt-6">
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <span className="text-xs sm:text-sm">Start a Conversation</span>
