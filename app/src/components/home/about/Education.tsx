...
const Education: React.FC = () => {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="absolute -top-3 -left-3 sm:-top-6 sm:-left-6 w-12 h-12 sm:w-24 sm:h-24 bg-ctp-sapphire/5 rounded-full blur-xl sm:blur-2xl hidden sm:block" />
      <div className="absolute -bottom-3 -right-3 sm:-bottom-6 sm:-right-6 w-12 h-12 sm:w-24 sm:h-24 bg-ctp-lavender/5 rounded-full blur-xl sm:blur-2xl hidden sm:block" />
      ...
      <div className="relative bg-gradient-to-br from-ctp-surface0/40 to-ctp-mantle/20 backdrop-blur-sm rounded-2xl sm:rounded-3xl border border-ctp-surface1/30 overflow-hidden w-full">
        {/* Header gradient bar */}
        <div className="h-0.5 sm:h-1 bg-gradient-to-r from-ctp-sapphire via-ctp-blue to-ctp-lavender" />
            ...
            {education.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-ctp-surface0/30 to-ctp-mantle/30 rounded-xl sm:rounded-2xl border border-ctp-surface1/30 hover:border-ctp-sapphire/30 transition-all duration-300 overflow-hidden group-hover:shadow-lg group-hover:shadow-ctp-sapphire/10 w-full">
                    {/* Card header with institution color */}
                    <div
                      className={`h-0.5 sm:h-1 bg-gradient-to-r ${
                        index === 0
                        ...
                        <div className="flex-1 min-w-0 overflow-hidden">
                          ...
                          <div className="space-y-1.5 sm:space-y-2">
                            {item.highlights.map((highlight, hIndex) => (
                              ...
                              >
                                <motion.div
                                  className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-ctp-surface0/20 hover:bg-ctp-surface0/40 rounded-lg sm:rounded-xl transition-colors duration-200 w-full overflow-hidden"
                                  whileHover={{ x: 2 }}
                                  transition={{
                                    type: "spring",
                                    stiffness: 300,
